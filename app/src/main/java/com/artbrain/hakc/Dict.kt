...
class Dict private constructor(private val db: SQLiteDatabase) {
    ...
    companion object {
         ...
         * 아직 글자가 되지 못한 자모.
         *
         * 자판은 낱자를 치는 동안 그것을 그대로 흘려 보낸다 — '한국' 을 치면
         * ㅎ · 하 · 한 · 한ㄱ · 한구 · 한국 순으로 온다. 홀로 선 자모는
         * [isHangul] 이 아니므로 찾기는 그 자락에 걸려 빈손으로 돌아온다.
         *
         * 호환 자모(ㄱ, U+3131~)와 첫·가운뎃·끝소리 자모(U+1100~)를 둘 다
         * 받는다 — 자판마다 흘려 보내는 것이 다르다.
         */
        fun isJamo(c: Char) = c in '\u3131'..'\u318E' || c in '\u1100'..'\u11FF'
